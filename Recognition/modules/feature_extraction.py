...
# class SEResNet_FeatureExtractor(nn.Module):
#     def __init__(self,output_channel=512):
#         super(SEResNet_FeatureExtractor,self).__init__()
#         self.model=models.ResNet(SEBottleneck,[3,4,6,3],num_classes=output_channel)
#         self.model.avgpool=nn.AvgPool2d(2)
